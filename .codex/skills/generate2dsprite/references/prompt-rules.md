...
- lock one outer bounding-box aspect ratio for all frames (for example `3:4`) and keep it unchanged frame-to-frame
- held weapons and props must remain inside that same outer bounding-box envelope in every frame
